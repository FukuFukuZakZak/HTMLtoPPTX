...
- Added optional 8bit appearance through a top-right gear and accessible native settings dialog. Both main/editor support the pixel font, blue/navy palettes, square panels and hard shadows in light/dark/system. Standard remains available. Bundled the full OFL-licensed DotGothic16 font as 500,340-byte WOFF2 for offline use. Both appearances pass 58 states each and produce identical slide XML. Saved the new executable/screenshots under `dist/ui-8bit-20260906/`; publishing was not part of this follow-up.
